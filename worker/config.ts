...
export const configSchema = z
  .object({
    ...
    reconciliationMaxRequests: z.number().int().min(1).max(60).default(30),
    explorationFraction: z.number().min(0).max(0.5).default(0.2),
    explorationRotationMs: z.number().int().min(60000).default(900000),
