...
Implementation checkpoints 1–3 and the dashboard/setup part of checkpoint 4 are implemented and tested. Checkpoint 4 remains open for credentialed live observation, throughput assessment and a true streaming research report. See docs/research/HANDOFF.md.
