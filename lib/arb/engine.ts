...
export function assess(pair:Pair,a:Book,b:Book,s:Settings,cash:{kalshi:number;poly:number},now=Date.now(),fillModel:(levels:Level[],q:number,rate:number,rounding:'ceil'|'even',venue:Venue)=>Fill|null=walk):Quote|null {
